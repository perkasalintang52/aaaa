...
let handler = async (m, { conn, text, participants, usedPrefix, command }) => {
    ...
    if (anu[0].attrs.error == 408) conn.sendButton(m.chat, `Tidak dapat menambahkan si beban @${anu[0].attrs.jid.split('@')[0]}!\nKabarnya si beban @${anu[0].attrs.jid.split('@')[0]} baru keluar dari grup ini :'v`, wm, 'link', usedPrefix + `link`, m)
